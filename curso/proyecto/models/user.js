...
var user_schema = new Schema({
    name: String,
    last_name: String,
    username: {type:String,required:true, maxlength:[30,"Su nombre de usuario es muy largo"]},
    password: {type: String,minlength:[8,"La contraseña es muy corta"],validate:password_validate},
